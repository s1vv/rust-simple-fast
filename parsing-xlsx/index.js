...
function parseExcelFile(filePath, logPath) {
  ...
  try {
    ...
    workbook = readSync(buffer, { type: "buffer", cellDates: true });
  } catch (e) {
...
`);
  ...
  rows.forEach((row, index) => {
    ...
    try {
      const name = typeof row["\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435"] === "string" ? row["\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435"].trim() : null;
      const stock = typeof row["\u041E\u0441\u0442\u0430\u0442\u043E\u043A"] === "number" ? row["\u041E\u0441\u0442\u0430\u0442\u043E\u043A"] : 0;
      const priceRaw = typeof row["\u0426\u0435\u043D\u0430 \u0437\u0430 1 \u0443\u043F."] === "number" ? row["\u0426\u0435\u043D\u0430 \u0437\u0430 1 \u0443\u043F."] : null;
      if (!name) {
      ...
      errorCount++;
      const fallbackName = typeof row["\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435"] === "string" ? row["\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435"] : "(\u0431\u0435\u0437 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u044F)";
      logStream.write(`\u041E\u0448\u0438\u0431\u043A\u0430 \u0432 \u0441\u0442\u0440\u043E\u043A\u0435 ${rowNum} '${fallbackName}': ${String(e)}
`);
    }
  });
  const dataList = Object.values(supplierData);
  logStream.end();
